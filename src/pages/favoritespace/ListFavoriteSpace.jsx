...
const ListFavoriteSpace = () => {
  const [isHoverHeart, setIsHoverHeart] = useState(false)
  return (
    <Link to="/spaces/:spaceId">
      <div className='gap-4 py-4 border-t border-orange-600'>
      <div className='w-full flex flex-center bg-[#fff9f3]'>
        <div className='w-2/5 h-[228px] relative'>
            <img className="w-full h-full object-cover"
              ...
              <p className="absolute top-3 left-3 uppercase bg-primaryColor text-white text-xs font-semibold px-4 py-[1px]">Toprate</p>
              <div className=" absolute bottom-3 left-3 right-3 flex justify-between text-white">
                  ...
                  <div className="font-bold">
                        ...
                        >Saved
                        {isHoverHeart ? <FontAwesomeIcon className="mx-1" icon={faHeart} color='red' /> : <FontAwesomeIcon className="mx-1" icon={faHeart} />}
                        </span>
                  </div>
              </div>
        </div>
        ...
        <div className="px-3 py-3 ">
                            ...
                            <div className="flex justify-between items-center mb-2">
                                <p className="text-xm font-bold text-green-600 text-textBoldColor">1.450.000 <span
                                    className="text-[#d4d4d4] font-thin">/ tháng</span></p>
                                <img src={anonAvatar} alt="avatar" className='w-[40px] h-[40px] rounded-full mx-3'/>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-2 text-[#8a8d91] text-sm">
                                ...
                                <div className="text-left ">
                                    <FontAwesomeIcon icon={faUserGroup} style={{color: "#8a8d91",}}/>
...
export default memo(ListFavoriteSpace);